  ...
  function Table(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_9__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7__["default"])(_this), "render", function () {
      ...
      return react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement("div", {
        ...
        __self: this
      }, !_this.state.loading ? _this.renderListThesis(search, filter, scope) : _this.renderLoading())));
    });

    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_9__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7__["default"])(_this), "renderListThesis", function (search, filter) {
      var check = false;
      var list = _this.state.listThesis;
      if (scope === 'OWN') list = _this.state.ownThesisInfo;
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(Table, [{
    ...
    value: function getOwnThesis() {
      ...
      _assets_request__WEBPACK_IMPORTED_MODULE_12___default()('/thesis/info', 'GET', 'section=self').then(function (result) {
        if (!result.result || !result.result[0] || result.result === [] || !result.httpCode === 200) _this2.ownThesisInfo = [];else _this2.ownThesisInfo = result.result;
      });
    }
  }]);
...
//# sourceMappingURL=index.js.9213c60a5538a8505462.hot-update.js.map