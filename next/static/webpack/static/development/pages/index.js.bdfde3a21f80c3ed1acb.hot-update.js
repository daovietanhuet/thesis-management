...
var doActivity = function doActivity(status, type, thesisId) {
  ...
  if (!config) return 0;
  var cf = confirm("Bạn có chắc chắn thực hiện hành động này không. Hành động này có thể ảnh hưởng lớn đến kết quả sau này");
  if (cf) _assets_request__WEBPACK_IMPORTED_MODULE_2___default()('/lecturer/thesis/' + config.endpoint + thesisId, config.methods).then(function (result) {
...
//# sourceMappingURL=index.js.bdfde3a21f80c3ed1acb.hot-update.js.map