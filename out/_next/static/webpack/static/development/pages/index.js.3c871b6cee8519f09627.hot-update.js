...
var TableRow = function TableRow(props) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", {
    ...
    onClick: function onClick(e) {
      return doActivity(state, 'pos', thesisId);
    },
    type: "button",
    __source: {
      fileName: _jsxFileName,
    ...
    onClick: function onClick(e) {
      return doActivity(state, 'neg', thesisId);
    },
    type: "button",
    __source: {
      fileName: _jsxFileName,
...
var doActivity = function doActivity(status, type, thesisId) {
  ...
  console.log(config);
  _assets_request__WEBPACK_IMPORTED_MODULE_2___default()('/lecturer/thesis/' + config.endpoint + thesisId, config.methods).then(function (result) {
...
//# sourceMappingURL=index.js.3c871b6cee8519f09627.hot-update.js.map