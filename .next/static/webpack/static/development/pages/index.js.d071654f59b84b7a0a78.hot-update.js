...
var TableRow = function TableRow(props) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", {
    ...
    __self: this
  }, studentName ? studentName : own ? '(chưa đăng ký)' : !state === 'NEW' ? '(bị ẩn)' : ''), " ", " ", localStorage.getItem('userRole') !== 'STU' ? thesisMark ? "(".concat(thesisMark, ")") : '(chưa có điểm)' : ''), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", {
    className: "summary",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 25
...
//# sourceMappingURL=index.js.d071654f59b84b7a0a78.hot-update.js.map